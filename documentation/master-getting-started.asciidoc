...
Our goal is to provide a smooth starting experience to all users of _devonfw_, no matter how experienced they are or what their stakeholder role is. To achieve this  this reason we provide a list of curated 

// IMPORTANT: Keep the following list in sync with '_Sidebar.asciidoc'!
