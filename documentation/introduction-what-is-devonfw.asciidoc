...
devonfw is a development platform aiming for the standardization of processes and boosing of productivity. It provides an architecture blueprint for server and client applications, alongside a set of tools to deliver a fully functional, _out-of-the-box_ development environment.
