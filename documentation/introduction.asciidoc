...
In the following section we will offer a brief overview of the main components and tools of devonfw and provide links for further reading:

=== devon4j
The _backend_ of most devonfw applications is built with Java. To speed up the development process, the link:https://github.com/devonfw/devon4j[devon4j] stack provides pre-selected frameworks and tools that ensure a secure backend-design which conforms with current standards.
