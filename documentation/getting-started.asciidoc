...
The shared experience across software developers is that there're some major reasons for a slow development process:
...
Some stacks are more concentrating on good documentation, others are focussing on reusable software components and we also provide completely bootstrapped applications that help you getting started immediately with an integrated set of good practices.
...
Sollicitor:: Every project we've seen in the last decades has a lot of open source software usage. 
But the least of them keep track of the license obligations or do at all provide any kind of catalogue what tools are in use.
...
We thought you would and prepared some https://www.katacoda.com/devonfw[Katakoda tutorials] for you. 
